...
public class CreateScheduledTaskRequestDto {
	...
	@Builder
	public CreateScheduledTaskRequestDto(List<ScheduledTaskScheduleRequestDto> schedules, TaskRequestApi task_request) {
