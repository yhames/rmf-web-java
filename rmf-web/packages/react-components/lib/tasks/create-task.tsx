...
export function CreateTaskForm({
  ...
  useEffect(() => {
    ...
    const allTasksValid = taskRequests.every((task) => {
      switch (task.category) {
        case 'clean':
          return isCleanTaskDescriptionValid(task.description as CleanTaskDescription);
        case 'patrol':
          return isPatrolTaskDescriptionValid(task.description as PatrolTaskDescription);
        case 'delivery':
          return isDeliveryTaskDescriptionValid(task.description as DeliveryTaskDescription);
        default:
          return false;
      }
    });
    allowSubmit(allTasksValid);
  }, [taskRequests]);
