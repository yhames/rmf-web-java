...
config = {
    ...
    # "db_url": "mysql://root:root@localhost:3306/rmf_db", # TODO: password should be in a secret
	"db_url": "postgres://root:root@localhost:5432/rmf_db", # TODO: password should be in a secret
