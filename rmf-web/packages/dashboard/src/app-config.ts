import { Authenticator, JwtAuthenticator, KeycloakAuthenticator, StubAuthenticator } from 'rmf-auth';
...
export const appConfig: AppConfig = (() => {
  ...
  const authenticator = (() => {
    if (!process.env.REACT_APP_AUTH_PROVIDER) { // TODO: change to use JwtAuthenticator
