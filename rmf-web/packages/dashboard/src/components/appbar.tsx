...
import { AppConfigContext, AppControllerContext, ResourcesContext, SettingsContext } from './app-contexts';
import { AppEvents } from './app-events';
import { RmfAppContext } from './rmf-app';
import { parseTasksFile, toApiSchedule } from './tasks/utils';
        ...
        <Toolbar variant="dense" sx={{ textAlign: 'right', flexGrow: -1 }}>
          ...
          {profile && (
            <>
              ...
              >
                <MenuItem id="profile-btn" onClick={() => {
                  setAnchorEl(null);
